...
with open("../tmp/frequency_distro_words", "w", encoding="utf8") as f:
  for node in word_nodes_list:
...
with open("../tmp/enwik8_dict_words", 'wb') as f:
...
with open("../tmp/frequency_distro_chars", "w", encoding="utf8") as f:
...
with open("../tmp/enwik8_dict_chars", 'wb') as f:
    # Pickle the 'data' dictionary using the highest protocol available.

...
print("This is the words array.. only putting the words with frequency greater than 1 in the dict")
final_nodes_dict = {}
final_nodes_dict_rare = {}
for key, value in nodes_dict.items():
    if value.frequency > 1000:
        final_nodes_dict[key] = value
    else:
        final_nodes_dict_rare[key] = value
...
with open("../../data/tmp/enwik8_dict_chars_rare", 'wb') as f:
    pickle.dump(final_nodes_dict_rare, f, pickle.HIGHEST_PROTOCOL)